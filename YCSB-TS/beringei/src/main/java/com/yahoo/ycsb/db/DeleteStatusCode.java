...
public class DeleteStatusCode {
  public static final int OK_PART = 0;
  public static final int OK_ALL = 1;
  ...
  public static final int OK_CURRENT = 7;
  public static final int OK_PREVIOUS = 8;
  public static final int TIME_OVER = 9;
  ...
  static {
    try {
      Class<?> klass = DeleteStatusCode.class;
