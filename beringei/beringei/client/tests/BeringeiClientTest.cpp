...
class BeringeiClientTest : public testing::Test {
 protected:
  void SetUp() override {
    ...
    b1.get(19, 29, 0, 50, getRes1.results[0].data, &storage);
    b2.get(19, 29, 0, 50, getRes2.results[0].data, &storage);

    getResult.results.resize(2);
    b1.get(19, 29,0, 50, getResult.results[0].data, &storage);
    b2.get(19, 29,0, 50, getResult.results[1].data, &storage);
    ...
    b1.get(19, 29, 0, 50, inProgressPartialRes.results[0].data, &storage);

    resWithHoles.results.resize(1);
    b1.get(19, 29, 0, 50, resWithHoles.results[0].data, &storage);
