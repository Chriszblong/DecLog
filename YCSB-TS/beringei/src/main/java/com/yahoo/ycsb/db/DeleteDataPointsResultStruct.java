...
public class DeleteDataPointsResultStruct implements TBase, java.io.Serializable, Cloneable, Comparable<DeleteDataPointsResultStruct> {
  private static final TStruct STRUCT_DESC = new TStruct("DeleteDataPointsResultStruct");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(DeleteDataPointsResultStruct.class, metaDataMap);
  }

  public DeleteDataPointsResultStruct() {
  }
   ...
   */
  public DeleteDataPointsResultStruct(DeleteDataPointsResultStruct other) {
  ...
  public DeleteDataPointsResultStruct deepCopy() {
    return new DeleteDataPointsResultStruct(this);
  }

  @Deprecated
  public DeleteDataPointsResultStruct clone() {
    return new DeleteDataPointsResultStruct(this);
  }
  ...
  public DeleteDataPointsResultStruct setKey(Key key) {
    this.key = key;
    return this;
  }
  ...
  public DeleteDataPointsResultStruct setValue(TimeValuePair value) {
    this.value = value;
    return this;
  }
  ...
  public DeleteDataPointsResultStruct setCategoryId(int categoryId) {
    this.categoryId = categoryId;
    setCategoryIdIsSet(true);
    return this;
  }
   ...
   * @see DeleteStatusCode
   */
  public DeleteDataPointsResultStruct setStatus(int status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DeleteDataPointsResultStruct)
      return this.equals((DeleteDataPointsResultStruct)that);
    return false;
  }

  public boolean equals(DeleteDataPointsResultStruct that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(DeleteDataPointsResultStruct other) {
    if (other == null) {
...
String space = prettyPrint ? " " : "";
    StringBuilder sb = new StringBuilder("DeleteDataPointsResultStruct");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
